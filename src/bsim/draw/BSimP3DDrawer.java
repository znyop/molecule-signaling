 ...
 */
 ...
 import src.bsim.capsule.BSimCapsuleBacterium;
 import processing.core.PConstants;
 import processing.core.PFont;
 import processing.core.PGraphics3D;
 
 import src.bsim.BSim;
 import src.bsim.BSimChemicalField;
 import src.bsim.BSimOctreeField;
 import src.bsim.geometry.BSimMesh;
 import src.bsim.geometry.BSimTriangle;
 import src.bsim.particle.BSimParticle;
 import src.bsim.particle.BSimVesicle;
 ...
 public abstract class BSimP3DDrawer extends BSimDrawer {
     ...
     public void drawRodShape(float radius, float length, int sides) {
         float angle = 0;
         float angleIncrement = PConstants.TWO_PI / sides;  //p3d.TWO_PI;
         // save a bunch of calculations:
         float lengthRatio = (length / 2.0f);
         p3d.beginShape(PConstants.QUAD_STRIP); //p3d.QUAD_STRIP
